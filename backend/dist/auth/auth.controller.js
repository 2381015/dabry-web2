...
const memory_auth_service_1 = require("./memory-auth.service");
...
let AuthController = class AuthController {
    constructor(authService, jwtService) {
        ...
        this.memoryAuthService = new memory_auth_service_1.MemoryAuthService(jwtService);
    }
    ...
    async login(loginDto) {
        try {
            ...
            const result = await this.memoryAuthService.login(loginDto.email, loginDto.password);
            if (!result) {
